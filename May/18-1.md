...
* 위 결과 화면 처럼 출력될 수 있도록 테스트 케이스 이용해     
  class 설계하고 만들 것.      
* 아래는 구현해야할 ListItem 의 클래스 다이어그램 입니다.    
![class diagram](https://user-images.githubusercontent.com/60066223/118598996-dd1f2180-b7e9-11eb-816a-d032af08649d.JPG)
* 위 다이어그램 참고해서 클래스 설계 하시면 됩니다!
